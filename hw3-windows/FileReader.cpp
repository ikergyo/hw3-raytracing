...
void FileReader::matransform(stack<mat4> &transfstack, float* values)
{
...
bool FileReader::readvals(stringstream &s, const int numvals, float* values)
{
...
std::unique_ptr<Scene> FileReader::readfile(const char* filename)
{
